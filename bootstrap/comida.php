...
<nav class="navbar navbar-inverse navbar-static-top">
	<div class="container">
	 ...
	 <div class="container" style="align-items: center; border-bottom-width: thick;">
	 	
    <form class="well form-horizontal" action="" method="post"  id="contact_form">
		<fieldset>

		<!-- Form Name -->
		<div><legend><label class="col-md-3 control-label"> Registro de Reserva</label> </legend>
		<img align="center" src="imagenes/Rest.jpeg"  width="30%" ></div>		
		...
		<div class="form-group"> 
			<label class="col-lg-4 control-label">Fecha de reservacion</label>
			<div class="col-md-4 inputGroupContainer">
				<div class="input-group">
		...
		<div class="form-group">
		  <label class="col-md-4 control-label">Cantidad de menus</label>  
		   <div class="col-md-4 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-user 	"></i></span>
